...
function init() {
  ...
  skills = {
    ...
    technomancer: [
      ...
      //--- 1 - Pestilence
      [ 0, [ 0, 2, 3 ], [ 2, 3 ], { "Weapon Damage": 0.08 } ],
      [ 0, [ 1, 4 ], [ 1, 4 ], { "Weapon Leech": 0.05 } ],
      [ 0, [ 1, 4 ], [ 1, 4 ], { "Skill Cooldown (Decay)": 0.15 } ],
      [ 0, [ 2, 3, 6, 7, 25 ], [ 2, 3, 5, 6, 7, 25 ], { "Armor Penetration": 0.1 } ],
      [ 0, [ 4 ], [], { "Weapon Damage (Sniper)": 0.2, "Drop Rate (Sniper)": 0.12 } ],
      [ 0, [ 4, 8 ], [ 4, 8 ], { "Decreased the distance considered to be Long Range by 6.5m (1)": null } ],
      [ 0, [ 4, 8 ], [ 4, 8 ], { "Toxic Duration": 0.3 } ],
      [ 0, [ 6, 7, 28 ], [ 6, 7, 9, 10, 11, 28 ], { "Weapon Damage": 0.08 } ],
      [ 0, [ 8 ], [], { "Activating an Ordinance Skill increases Weapon Damage for you and your allies by 30% for 10s": null } ],
      [ 0, [ 8 ], [ 12 ], { "Decreased the distance considered to be Long Range by 6.5m (2)": null } ], //--- 10
      [ 0, [ 8 ], [ 12 ], { "Damage (Against Toxic'ed)": 0.1 } ],
      [ 0, [ 10, 11 ], [ 13, 14, 15 ], { "Weapon Damage": 0.08 } ],
      [ 0, [ 12 ], [], { "Weapon Damage (Assault)": 0.2, "Drop Rate (Assault)": 0.12 } ],
      [ 0, [ 12 ], [ 16 ], { "Weapon Damage (Assault)": 0.12 } ],
      [ 0, [ 12 ], [ 16 ], { "Weapon Damage (Sniper)": 0.12 } ],
      [ 0, [ 14, 15 ], [ 17, 19 ], { "Armor Penetration": 0.1 } ],
      [ 0, [ 16 ], [], { "Damage Taken": 0.15, "Damage": 0.2 } ],
      [ 0, [ 16 ], [ 19, 20 ], { "Damage (Long Range)": 0.3 } ],
      [ 0, [ 18 ], [], { "Increase your Anomaly Power by 12% for each unlocked Br/8 Impact Amplifier node": null } ],
      [ 0, [ 18 ], [ 21, 22 ], { "Magazine Size": 0.5 } ], //--- 20
      [ 0, [ 20 ], [ 23 ], { "First bullet after reload deals 200% damage (5s cooldown)": null } ],
      [ 0, [ 20 ], [ 23 ], { "Damage (Against Toxic'ed)": 0.3 } ],
      [ 0, [ 21, 22 ], [], { "Activating a Decay Skill increases Weapon Damage for you and your allies by 40% for 10s": null } ],
      
      //--- 24
      [ 0, [ 4, 25 ], [ 4, 25 ], { "Crit Damage": 0.15 } ],
      [ 0, [ 24, 32 ], [ 24, 32, 26 ], { "Every time Toxic is applied on an enemy, Vulnerable is applied aswell": null } ],
      [ 0, [ 25 ], [], { "Vulnerability Effectiveness": 0.4 } ],
      [ 0, [ 8, 35 ], [ 8, 28, 35 ], { "Health Regen in increased by up to 20% of Maximum Health when you recive no damage": null } ],
      [ 0, [ 27 ], [], { "Turrets' Health Decay": -0.3 } ],
      
      //--- 29 - Tech Shaman
      [ 0, [ 0, 30, 31 ], [ 30, 31 ], { "Health": 0.1 } ],
      [ 0, [ 29, 32 ], [ 29, 32 ], { "Resistance": 0.2 } ],
      [ 0, [ 29, 32 ], [ 29, 32 ], { "Skill Cooldown (Gadget)": 0.15 } ],
      [ 0, [ 25, 30, 31, 33, 34, 49 ], [ 25, 30, 31, 33, 34, 49 ], { "Health": 0.1 } ],
      [ 0, [ 32, 35 ], [ 32, 35 ], { "Armor": 0.2 } ],
      [ 0, [ 32, 35 ], [ 32, 35 ], { "Damage (Against Frozen)": 0.1 } ],
      [ 0, [ 27, 33, 34, 52 ], [ 27, 33, 34, 36, 37, 52 ], { "Health": 0.1 } ],
      [ 0, [ 35 ], [ 38 ], { "Skill Leech": 0.06 } ],
      [ 0, [ 35 ], [ 38 ], { "Skill Cooldown (Gadget)": 0.15 } ],
      [ 0, [ 36, 37 ], [ 39, 40, 41 ], { "Health": 0.1 } ],
      [ 0, [ 38 ], [], { "Increase Turrets health by 100%": null } ], //--- 39
      [ 0, [ 38 ], [ 41 ], { "Every time Freeze is applied on an enemy, Vulnerable is applied aswell": null } ], //--- 39
      [ 0, [ 40 ], [], { "Vulnerability Effectiveness": 0.4 } ],
      [ 0, [ 38 ], [ 44 ], { "Armor": 0.2 } ],
      [ 0, [ 38 ], [ 44 ], { "Freeze Duration": 0.2 } ],
      [ 0, [ 42, 43 ], [ 45 ], { "Weapon Leech": 0.05 } ],
      [ 0, [ 44 ], [ 46, 47 ], { "Armor": 0.2 } ],
      [ 0, [ 45 ], [], { "Activating a Gadget Skill increases all Healing received for you and your allies by 30% for 7s": null } ],
      [ 0, [ 47 ], [ 50 ], { "Skill Leech": 0.06 } ],
      [ 0, [ 47 ], [ 50 ], { "Damage (Against Frozen)": 0.3 } ],
      [ 0, [ 48, 49 ], [], { "Activating a Gadget Skill increases your Weapon Damage and Anomaly Power by 40% for 10s": null, "Upon losing all your health you will receive a second chance to return to the battle with 50% health for 10s (180s cooldown)": null } ],
      
      //--- 49
      [ 0, [ 32, 53 ], [ 32, 52, 53 ], { "After using your melee skill, gain 40% Damage Mitigation for 3s": null } ],
      [ 0, [ 51 ], [], { "Freeze Duration": 0.2 } ],
      [ 0, [ 51, 58 ], [ 51, 58 ], { "Damage (Sidearms)": 0.12 } ],
      [ 0, [ 35, 62 ], [ 35, 62 ], { "Damage (To Enemies below 30% Health": 0.2 } ],
      
      //--- 55 - Demolisher
      [ 1, [ 1, 56, 57 ], [ 56, 57 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 55, 58 ], [ 55, 58 ], { "Skill Cooldown (Ordinance)": 0.15 } ],
      [ 1, [ 55, 58 ], [ 55, 58 ], { "Resistance Penetration": 0.15 } ],
      [ 1, [ 53, 56, 57, 60, 61 ], [ 53, 56, 57, 59, 60, 61 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 58 ], [], { "Your Melee skill also applies Toxic to every enemy hit": null } ],
      [ 1, [ 58, 62 ], [ 58, 62 ], { "Resistance": 0.2 } ],
      [ 1, [ 58, 62 ], [ 58, 62 ], { "First shot after reloading deals bonus damage equal to 15% of your Anomaly Power": null } ],
      [ 1, [ 54, 60, 61 ], [ 54, 60, 61, 63, 64, 65 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 62 ], [], { "Activating a Decay Skill increases Weapon Damage for you and your allies by 30% for 10s": null } ],
      [ 1, [ 62 ], [ 66 ], { "Skill Cooldown (Ordinance)": 0.15 } ],
      [ 1, [ 62 ], [ 66 ], { "Toxic Duration": 0.3 } ], //--- 65
      [ 1, [ 64, 65 ], [ 67, 68, 69 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 66 ], [], { "Activating an Ordinance Skill increases your Skill Leech by 15% for 7s": null } ],
      [ 1, [ 66 ], [ 70 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 66 ], [ 70 ], { "Damage (Toxic)": 0.2 } ],
      [ 1, [ 68, 69 ], [ 71, 73 ], { "Resistance Penetration": 0.15 } ],
      [ 1, [ 70 ], [ 72 ], { "Skill Leech": 0.06 } ],
      [ 1, [ 71 ], [], { "Activating an Ordinance Skill increases your Armor by 50% for 15s": null } ],
      [ 1, [ 70 ], [ 74, 75 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 73 ], [], { "Decreases Elite's damage against you and your allies by 10%": null } ],
      [ 1, [ 73 ], [ 76, 77 ], { "Doubles your Skill Leech when Health drops below 30%": null } ], //--- 75
      [ 1, [ 75 ], [ 78 ], { "Anomaly Power": 0.06 } ],
      [ 1, [ 75 ], [ 78 ], { "Damage (Toxic)": 0.2 } ],
      [ 1, [ 76, 77 ], [], { "Activating an Ordinance Skill increases your Anomaly Power by 50% for 10s": null } ]
    ]
  }
