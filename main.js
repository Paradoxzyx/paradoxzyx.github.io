...
function loadData() {
  ...
  skills = {
    trickster: [
      ...
      /* 3  */ [ 0, [ 1, 4 ], [ 1, 4 ], "Ace of Trumps", { "Armor Piercing": 0.15 } ],
      /* 4  */ [ 0, [ 2, 3, 6, 7, 25 ], [ 2, 3, 5, 6, 7, 25 ], "Death Probability", { "Weapon Damage": 0.08 } ],
      /* 5  */ [ 0, [ 4 ], [], "Shotgun Master", { "Weapon Damage (Shotgun)": 0.15, "Drop Rate (Shotgun)": 0.12 } ],
      ...
      /* 9  */ [ 0, [ 8 ], [], "Distruptive Firepower", { "Activating a Deception Skill increases Weapon Damage by 50% for 8s": null } ],
      /* 10 */ [ 0, [ 8 ], [ 12 ], "Singularity", { "Skill Cooldown (Deception)": 0.15 } ],
      /* 11 */ [ 0, [ 8 ], [ 12 ], "Ace of Trumps", { "Armor Piercing": 0.15 } ],
      /* 12 */ [ 0, [ 10, 11 ], [ 13, 14, 15 ], "Unforseen End", { "Weapon Damage (From Behind)": 0.2 } ],
      /* 13 */ [ 0, [ 12 ], [], "Scion of the Power", { "When your Damage Skill ends, increase Weapon Damage by 50% for 8s": null } ],
    ...
    pyromancer: [
       ...
       /* 6  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Blood Boil", { "Armor Piercing": 0.15 } ],
       ...
       /* 13 */ [ 0, [ 12 ], [], "Sniper Master", { "Weapon Damage (Sniper)": 0.4, "Drop Rate (Sniper)": 0.12 } ],
       /* 14 */ [ 0, [ 12 ], [ 16 ], "Blood Boil", { "Armor Piercing": 0.15 } ],
       ...
       /* 22 */ [ 0, [ 21 ], [ 24 ], "Trial of the Ashes", { "Damage (Against Ashed)": 0.3 } ],
       /* 23 */ [ 0, [ 21 ], [ 24 ], "Marble Orchard", { "Skill Cooldown (Immobilize)": 0.15 } ],
       /* 24 */ [ 0, [ 22, 23 ], [], "Burning Situation", { "Activating an Immobilize Skill increases Weapon Damage by 60% for 10s": null } ],
       ...
       /* 57 */ [ 0, [ 56, 59 ], [ 56, 59 ], "Mark's Cumulation", { "Skill Damage (Against Marked)": 0.1 } ],
       ...
       /* 60 */ [ 0, [ 59 ], [], "With Fire and Rifle", { "Activating an Explosive Skill increases Weapon Damage by 45% for 10s": null } ],
       /* 61 */ [ 0, [ 59, 63 ], [ 59, 63 ], "Mark's Cumulation", { "Skill Damage (Against Marked)": 0.1 } ],
    ...
    devastator: [
       ...
       /* 23 */ [ 0, [ 21 ], [ 24 ], "Armorbreaker", { "Armor Piercing": 0.15 } ],
    ...
    technomancer: [
       ...
       /* 4  */ [ 0, [ 2, 3, 6, 7, 24 ], [ 2, 3, 5, 6, 7, 24 ], "Drill Coating", { "Armor Piercing": 0.15 } ],
       /* 5  */ [ 0, [ 4 ], [], "Sniper Master", { "Weapon Damage (Sniper)": 0.4, "Drop Rate (Sniper)": 0.12 } ],
       ...
       /* 16 */ [ 0, [ 14, 15 ], [ 17, 18 ], "Drill Coating", { "Armor Piercing": 0.15 } ],
  ...
  let abilitydesc = {
    ...
    pyromancer: {
      "Thermal Bomb": "Select an enemy to Burn, Interrupt and deal [Z] damage to. If killed while still afflicted by the skill, the enemy will explode, dealing [X] damage within a large radius.",
      "Overheat": "Deal [Z] damage to all enemies within a large radius and Interrupt their skills. Enemies afflicted with Burn receive [X] damage instead (the Burn will be consumed).",
      ...
      "Heatwave": "Summon a fiery wave that deals [Z] damage and inflicts Burn onto all enemies in its path.",
      ...
      "Feed the Flames": "Select and pull an enemy towards you dealing [Z] damage, draining [X] Health, and inflicting Ash.",
      "Ash Blast": "Create an Anomaly blast to inflict Ash onto all enemies within a large radius around you.",
    },
    devastator: {
      "Gravity Leap": "Leap into the air and strike your targets from above, dealing [Z] damage and Interrupting enemies within a small radius of the area you land in.",
      ...
      "Earthquake": "Release a shockwave to deal [Z] damage and Interrupt all enemies in front of you.",
    ...
    technomancer: {
      "Blighted Rounds": "Fill your current weapon's magazine with decay-infused bullets that inflict Toxic onto enemies. Enemies within a small radius of the main target also receive Toxic and [Z]% of damage. The skill lasts until you reload or switch weapons.",
      ...
      "Cryo Turret": "Place an automated turret that deals [Z] damage and inflicts Freeze onto enemies. The turret's health depletes slowly over time and when it takes damage.",
      ...
      "Scrapnel": "Throw a proximity mine. The explosion deals [Z] damage and Interrupts the skills of enemies caught within the blast radius.",
      "Pain Launcher": "Place a missile launcher and bomb the area in front of you. Each missile deals [Z] damage per hit and Interrupts enemy skills.",
